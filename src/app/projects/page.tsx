          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="space-y-2 px-5 py-6">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">{project.data.title}</h3>
                {project.data.description ? (
                  <p className="text-sm text-slate-600 dark:text-slate-400">{project.data.description}</p>
                ) : null}
              </div>
            </article>
          ))}
